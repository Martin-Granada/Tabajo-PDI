...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, help_text='13 caracteres (Ejemplo: 9783161484100)')
...
class BookInstance(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text="ID único para este ejemplar de libro")
